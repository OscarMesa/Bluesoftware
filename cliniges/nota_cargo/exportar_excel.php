...
<table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 993px">
 ...
 <td>
  ...
  <td style="width: 86%" colspan="7" ><div align="center">
	  <span >LISTADO DE NOTAS  CARGO DEL <? echo $fecha_ini;?> AL <? echo $fecha_fin;?> </span> </div></td>
  </tr>
  <tr>
	  ...
	  <?php
		   ...
		   $selectnota="select * from detalle_nota where id_nota='$id_nota' ";
	       mysql_select_db($basedatos, $conectBD);
	  ...
	  ?> <tr>
	       <td colspan="4"></td>
		      ...
		      <? 
		       $valor_nota=$arreglonota['valor'];
		      echo number_format($valor_nota, 0, '.', '') ;
   ...
   <tr><td colspan="6" align="right"><strong>Total Nota #</strong> <? echo $arreglo['no_documento'];?></td> <td align="center">$ <? echo number_format($total_nota, 0, '.', '');?></td></tr>
      ...
      <tr><td colspan="6" align="right">Total</td> <td align="center">$ <? echo number_format($total, 0,'.', '');?></td></tr>
