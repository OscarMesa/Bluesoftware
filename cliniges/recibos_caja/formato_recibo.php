...
?>
   ...
   <table width="800" align="center">
	...
	<tr>
	<td class="style4" style="height: 10px; width: 69px;"><?php echo $fecha?></td>
     ...
     <tr>
   <td style="width: 182px" colspan="3">Ciudad</td><td> <?php   echo $ciudad; ?></td>
   ...
   <tr>
   <td style="width: 182px" colspan="3"> Pagado a:</td><td> <?php   echo $nombre; ?></td>

   </tr>
   
   <tr>
   <td style="width: 182px" colspan="3">Nit</td><td> <?php   echo $nit; ?></td>

   </tr>
   
   <tr>
   <td style="width: 182px" colspan="1" > Concepto:</td><td colspan="3"> <?php echo $concepto; ?></td>
   ...
   ?>
    <td colspan="3"> <strong>Son: </strong> <?php echo numtoletras($valor);?></td>
    <td colspan="1">$ <?php echo number_format($valor, 0, ".", ",");?> </td>

       
       
        <tr>
    <td colspan="4"> Elaborado: <?php echo $elaborado;?></td> 
