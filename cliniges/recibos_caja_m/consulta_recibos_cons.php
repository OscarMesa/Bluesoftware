...
<div id="content_wrapper">
  <div id="content">
	...
	<legend style="color:#33CC00"><strong>LISTA DE RECIBOS DE CAJA</strong></legend>
     ...
     <? include("logo.php");?>
       ...
       $select="select * from recibo_caja_m where fecha between '$fecha_ini' and  '$fecha_fin' ";
...
<td>
  ...
  <img  src="../images/borrador.png" alt="" name="Image6" width="22" height="19" border="0">
      ...
      <? if ($arreglo['id_cliente']==0) {$total=$total+$arreglo['valor'];}}?>
