...
<div id="content_wrapper">
  <div id="content">
	...
	<legend style="color:#33CC00"><strong>LISTA DE EGRESOS</strong></legend>
     ...
     <? include("logo.php");?>
       ...
       $select="select * from egreso where fecha between '$fecha_ini' and  '$fecha_fin' ";
	  ...
	  <input type="text"  value="<? echo $arreglo['fecha']?>"style="width: 96px"></td>
       ...
       <td>
		<div><a href="../../impresiones/formato_egreso.php?id_equivalente=<?  echo $arreglo['id_equivalente'];?>" target="popup" onclick='window.open("", "popup", "")' > 
  ...
  <div id="sidebar">
   <div>
    ...
    <div class="sidebar_section">
      <h2 class="style4">Egresos</h2>
      <div class="sidebar_section_content">
        <ul class="categories_list">
                       <lu></lu>
          
                   
            <li><a href="#"><strong>Egresos</strong></a>
               <lu></lu>
          </li>

          <li><a href="egresos.php">Egresos</a>
               <lu></lu>
          </li>
