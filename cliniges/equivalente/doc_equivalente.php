...
require_once("../../comun.php");
 ...
 $mysqlinv = " select * from  parametrizacion_factura";
	...
	{
	 $no_documento=$arreglo['factura_equivalen'];
	}
...
<form id="form1" name="form1" action='guardar.php' method='post' onsubmit="return validarFormulario (this)">
 ...
 <td colspan="5">
 		...
 		<tr>
				  ...
				  <input type="date"  name="fecha_documento" id="fecha_documento" value="<?php echo date("Y-m-d",time());?>" style="width: 155px"/>
 		  </td>

 		</tr>
 		<tr>
 		  		  <td style="width: 238px"><div align="right">Documento equivalente No</div>
				  <td style="width: 338px"> 
 		...
 		<tr>
			...
			$estado.="<select name='cedula' style='width: 300px' id='cedula' >";
	     	...
	     	$select="select * from cliente where tipo_cliente='1'  order by nombre ASC";
						mysql_select_db($basedatos,$conectBD);
