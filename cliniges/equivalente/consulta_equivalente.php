...
<div id="content_wrapper">
  <div id="content">
	...
	<legend style="color:#33CC00"><strong> FILTRO DOCUMENTO EQUIVALENTE</strong></legend>
      
     <table align="center" style="width: 537px; height: 122px">
     <form action="consulta_equivalente_cons.php" method="post">
       <tr>
    <td>
     <? include("logo.php");?>
     </td>
  ...
  <div id="sidebar">
   <div>
    ...
    <div class="sidebar_section">
      <h2 class="style4">Documento equivalente</h2>
