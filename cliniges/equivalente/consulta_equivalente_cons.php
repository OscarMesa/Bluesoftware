...
<div id="content_wrapper">
  <div id="content">
	...
	<legend style="color:#33CC00"><strong>LISTA DE DOCUMENTO EQUIVALENTE</strong></legend>
     ...
     <? include("logo.php");?>
         ...
         <tr>
         <td align="CENTER"><strong>#Doc
         </strong>
         </td> 
         <td  align="center"><strong>Fecha
         </strong>
         </td>
          <td align="center"><strong>Proveedor
         </strong>
         </td>
       ...
       $select="select * from equivalente where fecha between '$fecha_ini' and  '$fecha_fin' ";
	  ...
	  <input type="text"  value="<? echo $arreglo['fecha']?>"style="width: 96px"></td>
       ...
       <td>
		<div><a href="../../impresiones/formato_equivalente.php?id_equivalente=<?  echo $arreglo['id_equivalente'];?>" target="popup" onclick='window.open("", "popup", "")' > 
  <img  src="../images/impresora.jpg" alt="" name="Image6" width="24" height="24" border="0">
   </a></div>
</td>
<td>
		<div><a href="anular_equivalente.php?id_equivalente=<?  echo $arreglo['id_equivalente'];?>" target="popup" onclick='window.open("", "popup", "")' > 
  ...
  <div id="sidebar">
   <div>
    ...
    <div class="sidebar_section">
      <h2 class="style4">Doc equivalente</h2>
      <div class="sidebar_section_content">
        <ul class="categories_list">
                       <lu></lu>
          
                   
          <li><a href="#"><strong>Documento equivalente</strong></a>
               <lu></lu>
          </li>

          <li><a href="doc_equivalente.php">Documento equivalente</a>
               <lu></lu>
          </li>
          <li><a href="consulta_equivalente.php">Consulta Documento equivalente</a>
               <lu></lu>
          </li>
