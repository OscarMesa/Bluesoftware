...
header("Content-Disposition: attachment; filename=Listado notas de documento equivalente.xls"); 
...
<table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 993px">
 ...
 <td>
  ...
  <td style="width: 86%" colspan="7" ><div align="center">
	  <span >LISTADO DE DOCUMENTO EQUIVALENTE DEL <? echo $fecha_ini;?> AL <? echo $fecha_fin;?> </span> </div></td>
  </tr>
  <tr>
       ...
       $select="select * from equivalente where fecha between '$fecha_ini' and  '$fecha_fin'  and estado=0";
       mysql_select_db($basedatos, $conectBD);
	  ...
	  <?php
		   ...
		   $selectnota="select * from detalle_equivalente where id_equivalente='$id_nota' ";
	       mysql_select_db($basedatos, $conectBD);
   ...
   <tr><td colspan="6" align="right"><strong>Total Doc #</strong> <? echo $arreglo['no_documento'];?></td> <td align="center">$ <? echo number_format($total_nota, 0, ".", ",");?></td></tr>
