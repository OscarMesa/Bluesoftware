...
?>
   ...
   <table width="800" align="center">
    ...
    <td>
	<a href="facturacion_ini.php">
	<img alt="" height="133" src="../../images/logo_sivana.png" width="278" style="float: left" class="style7"></a></td>
    </tr>
...
?> del <? echo  $fecha_desde;?> al  <? echo  $fecha_hasta; ?></td>
   ...
   ?>
    ...
    <td style="width: 221px"> Contabilizado : <? echo $contabilizado;?></td>
     ...
     <tr><td  colspan="4" class="style5"><strong>Esta factura de venta se asimila en todos sus efectos legales a una letra
