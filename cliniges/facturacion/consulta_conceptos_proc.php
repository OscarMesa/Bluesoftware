...
<div id="content_wrapper">
  <div id="content">
	...
	<legend style="color:#33CC00"><strong>CONFIGURACION DE CONCEPTOS</strong></legend>
     ...
     <form action="modificar_concepto.php" method="post">
         	    ...
         	    $id_concepto=$_GET['id_concepto'];
         	     $select="select * from conceptos where  id='$id_concepto'";
       ...
       {
        $concepto=$arreglo['codigo'];
        $nombre_concepto=$arreglo['nombre_concepto'];
        $valor=$arreglo['valor'];
        $signo=$arreglo['signo'];
       }
                ...
                <td>
				<input type="text" name="concepto" value="<? echo $concepto;?>" style="width:258px" onKeypress=" return validar_texto(event);" /></td>
                </tr>
               <tr>
                <td><div align="right">Nombre<span class="style1">*</span></div></td>
                <td>
				<input type="text" name="nombre"  value="<? echo $nombre_concepto;?>"style="width:258px" onKeypress=" return validar_texto(event);"  /></td>
                </tr>
                <tr>
                <td><div align="right">Valor unitario<span class="style1">*</span></div></td>
                <td>
				<input type="text" name ="valor"  value="<? echo $valor;?>"id="sel2" style="width: 258px"/></td>
                </tr>
                
                 <tr>
                <td><div align="right">Signo *</div></td>
                <td>+
				<input type="radio" name ="signo" value="1" <? if($signo=='1'){ ?> checked="checked"<? };?>/>
				
				-<input type="radio" name ="signo" value="2"  <? if($signo=='2'){ ?> checked="checked"<? };?>/></td>

                </tr>

                                <tr>
                <td width="55%" colspan="2" style="width: 100%"><div align="center">
                  <input type="submit" name="Submit" value="Modificar" onClick="javascript:validarcampos()"  />
